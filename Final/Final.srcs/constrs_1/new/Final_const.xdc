...
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[8]}]
#set_property PACKAGE_PIN V3 [get_ports {pdata[9]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[9]}]
#set_property PACKAGE_PIN W3 [get_ports {pdata[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[10]}]
#set_property PACKAGE_PIN U3 [get_ports {pdata[11]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[11]}]
#set_property PACKAGE_PIN P3 [get_ports {pdata[12]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[12]}]
#set_property PACKAGE_PIN N3 [get_ports {pdata[13]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[13]}]
#set_property PACKAGE_PIN P1 [get_ports {pdata[14]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[14]}]
#set_property PACKAGE_PIN L1 [get_ports {pdata[15]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {pdata[15]}]
...
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {s_clk}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s_clk}]
#set_property PULLTYPE {PULLUP} [get_ports {s_clk}]
##Sch name = JA4
#set_property PACKAGE_PIN G2 [get_ports {sdata_io}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sdata_io}]
#set_property PULLTYPE {PULLUP} [get_ports {sdata_io}]
##Sch name = JA7
...
##Sch name = JA9
#set_property PACKAGE_PIN H2 [get_ports {s_clk}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s_clk}]
#set_property PULLTYPE {PULLUP} [get_ports {s_clk}]
##Sch name = JA10
#set_property PACKAGE_PIN G3 [get_ports {sdata_io}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sdata_io}]
#set_property PULLTYPE {PULLUP} [get_ports {sdata_io}]
...
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {I_clk}]
set_property IOSTANDARD LVCMOS33 [get_ports {I_clk}]
set_property PULLTYPE {PULLUP} [get_ports {I_clk}]
##Sch name = JB4
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {cs0_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {cs0_n}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {data_1}]
set_property IOSTANDARD LVCMOS33 [get_ports {data_1}]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {data_2}]
set_property IOSTANDARD LVCMOS33 [get_ports {data_2}]
##Sch name = JC4
...
set_property PACKAGE_PIN A18 [get_ports {sdata_o}]
set_property IOSTANDARD LVCMOS33 [get_ports {sdat_o}]
